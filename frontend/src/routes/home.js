    ...
    <>
        ...
        <section className={styles.header_seperator}>
          <div className={styles.seperator_wrap}>
            ...
            <div className={styles.enquiry_wrap}>
              <div>
                <Link to="/contact" className={`${styles.makeEnquiry} ${styles.enquiry_seperator}`}>
                  Make an enquiry
                </Link>
              </div>
            </div>
      ...
      <div className={styles.main_wrapper}>
        <main className={styles.main}>
          ...
          >
            <p>
              We use veterinary expertise and sound nutrition advice to improve animal health,
              operational efficiency and profitability for New Zealand dairy farmers.
            </p>
          </ImageTextParallelSection>
          ...
          >
            <p>
              We provide on-farm investigation and records analysis that identify opportunities
              allowing implementation of sustainable solutions for challenges with:
            </p>
            <ul>
          ...
          >
            <p>
              We work with you to develop feeding strategies and trace mineral formulations to
              successfully prepare your cows for calving, lactation and mating through:
            </p>
            <ul>
    ...
    return (
      <section className={styles.testimonialContainer}>
        <div className={styles.testimonialImageContainer}>
          <img src={img} alt={img_alt} className={styles.testimonialsImages}></img>
        </div>
        <article>
          <h3>{title}</h3>
          <div>{children}</div>
